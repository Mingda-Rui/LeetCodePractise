...
public class _4_7BuildOrderTest {
  ...
  public void testFindBuildOrder() {
    ...
    String[] orderedBuild = _4_7BuildOrder.findBuildOrder(
      projects,
      dependencies
    );
    boolean isEqual =
      Arrays.compare(
        new String[] { "e", "f", "a", "b", "d", "c" },
        orderedBuild
      ) ==
      0;
    isEqual =
    ...
    RuntimeException ex = assertThrows(RuntimeException.class, () ->
      _4_7BuildOrder.findBuildOrder(projects2, dependencies2)
    );
  ...
  public void testFindBuildOrderDfs() {
    ...
    String[] orderedBuild = _4_7BuildOrder.findBuildOrderDfs(
      projects,
      dependencies
    );
