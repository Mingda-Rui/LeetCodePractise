...
public class _4_7BuildOrderTest {
  ...
  public void testFindBuildOrder() {
    ...
    boolean isEqual =
        Arrays.compare(new String[] {"e", "f", "a", "b", "d", "c"}, orderedBuild) == 0;
    isEqual =
        isEqual || Arrays.compare(new String[] {"f", "e", "a", "b", "d", "c"}, orderedBuild) == 0;
    isEqual =
        isEqual || Arrays.compare(new String[] {"e", "f", "b", "a", "d", "c"}, orderedBuild) == 0;
    isEqual =
        isEqual || Arrays.compare(new String[] {"f", "e", "b", "a", "d", "c"}, orderedBuild) == 0;
    assertTrue(isEqual);

    String[] projects2 = new String[] {"a", "b", "c"};
    String[][] dependencies2 =
        new String[][] {new String[] {"a", "b"}, new String[] {"b", "c"}, new String[] {"c", "a"}};
    RuntimeException ex =
        assertThrows(
            RuntimeException.class, () -> _4_7BuildOrder.findBuildOrder(projects2, dependencies2));
  ...
  public void testFindBuildOrderDfs() {
    ...
    isEqual =
        isEqual || Arrays.compare(new String[] {"f", "e", "b", "a", "d", "c"}, orderedBuild) == 0;
    isEqual =
        isEqual || Arrays.compare(new String[] {"f", "a", "b", "d", "c", "e"}, orderedBuild) == 0;
    assertTrue(isEqual);
