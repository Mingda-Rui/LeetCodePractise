...
public class LC0889ConstructBinaryTreeFromPreorderAndPostorderTraversal {
  ...
  public TreeNode constructFromPrePostRefactored(
    int[] preorder,
    int[] postorder
  ) {
  ...
  public TreeNode constructFromPrePostRecursive(
    int[] preorder,
    int[] postorder
  ) {
    Map<Integer, Integer> map = new HashMap<>();
    for (int i = 0; i < postorder.length; i++) map.put(postorder[i], i);
    return constructFromPrePostRecursive(
      preorder,
      new int[] { 0 },
      postorder,
      postorder.length,
  ...
  private TreeNode constructFromPrePostRecursive(
    ...
    node.left = constructFromPrePostRecursive(
      preorder,
      preIndexHolder,
      postorder,
      postIndex,
    ...
    node.right = constructFromPrePostRecursive(
      preorder,
      preIndexHolder,
      postorder,
      postIndex,
  ...
  public TreeNode constructFromPrePostRecursiveStartEnd(
    int[] preorder,
    int[] postorder
  ) {
    Map<Integer, Integer> map = new HashMap<>();
  ...
  private TreeNode constructFromPrePostRecursiveStartEnd(
    ...
    node.left = constructFromPrePostRecursiveStartEnd(
      preorder,
      preIndexHolder,
      postorder,
      postS,
  ...
  public TreeNode constructFromPrePost(int[] preorder, int[] postorder) {
    return constructFromPrePostRecursiveSimplest(
      preorder,
      new int[] { 0 },
      postorder,
      new int[] { 0 }
  ...
  private TreeNode constructFromPrePostRecursiveSimplest(
    ...
    if (val != postorder[postIndexHolder[0]]) root.left =
    ...
    if (val != postorder[postIndexHolder[0]]) root.right =
      constructFromPrePostRecursiveSimplest(
        preorder,
        preIndexHolder,
        postorder,
