...
class Solution_String {
    ...
    public int reverse(int x) {
        ...
        if (numInString.charAt(0) == negativeSign) {
            String unsignedReversedNum = new StringBuilder(numInString.substring(1, lengthOfString))
                    .reverse()
                    .toString();
    ...
    private int reverseNum(String num) {
        ...
        return lowerBoundary <= reversedNumInLong && reversedNumInLong <= upperBoundary ? (int) reversedNumInLong : 0;
    }
}
