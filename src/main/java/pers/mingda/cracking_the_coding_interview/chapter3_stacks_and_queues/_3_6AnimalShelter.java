 ...
 * "first in, first out" basis. People must adopt either the "oldest" (based on arrival time) of all
 * animals at the shelter, or they can select whether they would prefer a dog or cat (and will
 ...
 * enqueue, dequeueAny, dequeueDog, and dequeueCat. You may use the built-in LinkedList data
 * structure.
 */
...
class AnimalQueue {
  ...
  public Animal dequeueAny() {
    ...
    else if (catQueue.isEmpty()) return dogQueue.poll();
