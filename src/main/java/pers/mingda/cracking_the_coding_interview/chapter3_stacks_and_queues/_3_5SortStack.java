...
/**
 * 3.5 Sort Stack: Write a program to sort a stack such that the smallest items are on the top. You
 * can use an additional temproary stack, but you may not copy the elements into any other data
